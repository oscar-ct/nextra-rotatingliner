...
The CAD illustration below describes our RLE Alpha Prototype converted to single cylinder (active cylinder is #2) by removing 1, 3, and 4 pistons / con rods and with Cylinder #2 rotating.  The design is such that all 4 cylinders can be rotating.
